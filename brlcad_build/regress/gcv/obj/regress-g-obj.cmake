...
set(ofiles  "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/obj/conv-tetra.obj" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/obj/conv-tetra-assetimport.obj")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"${in_path}\" \"D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/obj/conv-tetra.obj\" 
  COMMAND \"${GCV_EXEC}\" \"--input-format=brlcad\" \"--output-format=assetimport\" \"${in_path}\" \"D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/obj/conv-tetra-assetimport.obj\"\n\n")
file(APPEND "${LOGFILE}" "${log_msg}")

execute_process(
  COMMAND "${GCV_EXEC}" "${in_path}" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/obj/conv-tetra.obj" COMMAND "${GCV_EXEC}" "--input-format=brlcad" "--output-format=assetimport" "${in_path}" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/obj/conv-tetra-assetimport.obj"
