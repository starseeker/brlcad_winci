...
set(CBDIR "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/fastgen")
set(CSDIR "D:/a/brlcad_winci/brlcad_winci/brlcad/regress/gcv/fastgen")
...
foreach(of ${OUTPUT_FILES})
  execute_process(
    COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E remove -f "${of}"
  )
...
execute_process(
  COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E tar xvf "${CSDIR}/fastgen_unix.tbz2"
...
execute_process(
  COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E tar xvf "${CSDIR}/fastgen_dos.tbz2"
  OUTPUT_VARIABLE fastgen_log
  ERROR_VARIABLE fastgen_log
  WORKING_DIRECTORY "${CBDIR}"
)
file(APPEND "${LOGFILE}" "${fastgen_log}")
execute_process(
  COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E compare_files "${CBDIR}/fastgen_dos.fast4" "${CBDIR}/fastgen_unix.fast4"
  RESULT_VARIABLE fastgen_result
  OUTPUT_VARIABLE fastgen_log
  ERROR_VARIABLE fastgen_log
  WORKING_DIRECTORY "${CBDIR}"
...
execute_process(
  COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E copy "${CBDIR}/fastgen_unix.fast4" "${CBDIR}/fastgen.fast4"
  RESULT_VARIABLE fastgen_result
  OUTPUT_VARIABLE fastgen_log
  ERROR_VARIABLE fastgen_log
  WORKING_DIRECTORY "${CBDIR}"
...
if(EXISTS "${CBDIR}/fastgen_unix.g")
  execute_process(COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E remove "${CBDIR}/fastgen.fast4")
...
execute_process(
  COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E remove "${CBDIR}/fastgen.fast4"
  OUTPUT_VARIABLE fastgen_log
  ERROR_VARIABLE fastgen_log
  WORKING_DIRECTORY "${CBDIR}"
)
file(APPEND "${LOGFILE}" "${fastgen_log}")
execute_process(
  COMMAND "D:/a/_temp/-1212469507/cmake-4.3.1-windows-x86_64/bin/cmake.exe" -E copy "${CBDIR}/fastgen_dos.fast4" "${CBDIR}/fastgen.fast4"
  OUTPUT_VARIABLE fastgen_log
  ERROR_VARIABLE fastgen_log
  WORKING_DIRECTORY "${CBDIR}"
)
