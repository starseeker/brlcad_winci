...
set(CSDIR "D:/a/brlcad_winci/brlcad_winci/brlcad/regress/gcv/ply")
set(CBDIR "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply")
...
set(ofiles  "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra.ply" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra-assetimport.ply")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"${in_path}\" \"D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra.ply\" 
  COMMAND \"${GCV_EXEC}\" \"--input-format=brlcad\" \"--output-format=assetimport\" \"${in_path}\" \"D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra-assetimport.ply\"\n\n")
file(APPEND "${LOGFILE}" "${log_msg}")

execute_process(
  COMMAND "${GCV_EXEC}" "${in_path}" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra.ply" COMMAND "${GCV_EXEC}" "--input-format=brlcad" "--output-format=assetimport" "${in_path}" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra-assetimport.ply"
