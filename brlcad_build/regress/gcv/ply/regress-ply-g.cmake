...
set(ofiles  "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra.g" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra-assetimport.g")
foreach(of ${ofiles})
  file(REMOVE "${of}")
...
set(log_msg "Running:
  COMMAND \"${GCV_EXEC}\" \"${in_path}\" \"D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra.g\" 
  COMMAND \"${GCV_EXEC}\" \"--input-format=assetimport\" \"--output-format=brlcad\" \"${in_path}\" \"D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra-assetimport.g\"\n\n")
file(APPEND "${LOGFILE}" "${log_msg}")

execute_process(
  COMMAND "${GCV_EXEC}" "${in_path}" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra.g" COMMAND "${GCV_EXEC}" "--input-format=assetimport" "--output-format=brlcad" "${in_path}" "D:/a/brlcad_winci/brlcad_winci/brlcad_build/regress/gcv/ply/conv-tetra-assetimport.g"
